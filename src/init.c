...
/*   Updated: 2026/05/05 12:59:19 by texenber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

# include "../inc/philos.h"

// this needs to be destroyed properly in case the forks fail.
...
int	init_philos(t_data *data)
{
	...
	if(!data->philos)
		return (ft_putstr_fd(ALLOC_FAIL, 2), 1);
	i = 0;
	while (i < data->p_num)
	{
		data->philos[i].id = i + 1;
		data->philos[i].last_meal = 0; // issues with this being set to zero 
